...
namespace CrudClassGenerator
{
    public partial class FormMain : Form
    {
        ...
        private WorkingModes WorkMode = WorkingModes.WCF;
        ...
        private void GetConnStr()
        {
            ...
            if (File.Exists(fullPath))
            {
                ...
                textBoxConnStr.Text = tr.ReadLine();
                tr.Close();
            }
        }
        ...
        {
            labelConnectionStatus.ForeColor = Color.DarkRed;
        ...
        {
            if (textBoxTable.Text.Length != 3) return;

            string search = string.Format("TableName LIKE '{0}%'", textBoxTable.Text);
